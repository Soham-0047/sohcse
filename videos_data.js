/* ==========================================================================
   GATE CSE — Curated Video Catalog v3
   - Fixed: All playlist IDs verified unique
   - Fixed: Search uses YouTube Data API v3 (with optional API key)
   ========================================================================== */
...
const VIDEO_CATALOG = {
    'algorithms': {
        ...
        playlists: [
            { id: 'PLDN4rrl48XKpZkf03iYFl-O29szjTrs_O', type: 'playlist', title: 'Algorithms — Complete Course', channel: 'Abdul Bari', description: 'The most popular GATE algorithms course on YouTube. Covers time complexity, sorting, searching, DP, greedy, divide & conquer, and graph algorithms.', videos: 100 },
    ...
    'operating-systems': {
        ...
        playlists: [
            ...
            { id: 'PLdo5W4Nhv31bJakmYCyGc2z7n5jz6vBUX', type: 'playlist', title: 'Operating System', channel: "Jenny's Lectures", description: 'Detailed OS lectures with diagrams — process scheduling algorithms, Banker\'s algorithm, paging, and segmentation.', videos: 70 },
        ],
        channels: [
    ...
    'database-management-system': {
        label: 'DBMS', icon: '🗄️',
        playlists: [
            { id: 'PLxCzCOWd7aiFAN6I8PViWLYQsrPphfCg8', type: 'playlist', title: 'DBMS Complete Course', channel: 'Gate Smashers', description: 'The most popular GATE DBMS course — ER model, relational model, normalization, SQL, transactions, concurrency control, indexing, and B+ trees.', videos: 110 },
        ],
        channels: [
    ...
    'computer-networks': {
        ...
        playlists: [
            ...
            { id: 'PLOG_8OlGMp73hMyn-WX1M2Q4ON98DmaRq', type: 'playlist', title: 'Computer Networks — Ankit Doyla (Unacademy)', channel: 'Ankit Doyla', description: 'Highly-rated CN playlist by Ankit Doyla Sir (Unacademy). Covers all GATE CN topics with detailed explanations.', videos: 60 },
        ],
        channels: [
    ...
    'theory-of-computation': {
        ...
        playlists: [
            ...
            { id: 'PLOG_8OlGMp72SAVxAk3VwEKQNbLkpN4Vs', type: 'playlist', title: 'TOC — Ankit Doyla (Unacademy)', channel: 'Ankit Doyla', description: 'Highly-rated TOC playlist by Ankit Doyla Sir (Unacademy). Covers automata theory, grammars, Turing machines, and decidability.', videos: 50 },
        ],
        channels: [
